...
class DiMuonMass(Module):
	...
	def beginJob(self,histFile=None,histDirName=None):
		...
		self.hM = r.TH1F("M", "DiMuon Mass", nbins, M_min, M_max)
...
p=PostProcessor(".",["5389C378-DE55-B145-992A-E9E72E8AA489.root"],cut="",branchsel="keep_and_drop.txt",modules=[DiMuonMass()],histFileName="hM.root",histDirName="hists")
p.run()